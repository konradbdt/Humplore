...
| Vertrauensproblem
| Verifizierung der Creator direkt nach der Registrierung.

| Entdecken von Creatorn
| Menschen mit spannenden Perspektiven posten nicht gerne öffenetlich. Anschreiben von Ngos, Betriebe (Feuerwehr), Social Media Nutzer

| Kreativität der Creator
| Über 1 spezifisches Thema zu sprechen ist für eine langfristige Sicht nicht eifnach. Universal-Leitfäden anbieten auf der Plattform.

| Schubladendenken
| Zu Beginn werden wir von vielen Menschen unterbewusst als eine weitere Plattform wahrgenommen. Das Design muss daher unseren USP klar hervorheben und den Nutzer bereits beim ersten Besuch direkt abholen
