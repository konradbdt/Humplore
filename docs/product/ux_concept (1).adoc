...
| Benutzer
| Die Plattform richtet sich an Personen, die aktiv Erfahrungen teilen oder nach authentischen Erfahrungsberichten suchen. Dazu gehören z. B. Studierende, Berufseinsteiger:innen, Fachkräfte oder allgemein neugierige Nutzer:innen. Die Nutzenden haben unterschiedliche digitale Kompetenzen, sind aber mit mobilen Apps und sozialen Plattformen vertraut. Motivation ist vor allem der Austausch von echten Erlebnissen sowie das Lernen aus den Erfahrungen anderer.

| Ziele & Aufgaben
| Nutzer:innen möchten:
- Eigene Erfahrungen strukturiert teilen (z. B. zu Studium, Beruf, Alltag)
- Erfahrungen anderer zu bestimmten Themen finden
- Fragen stellen und Antworten aus erster Hand erhalten
- Sich orientieren (z. B. bei Entscheidungen oder neuen Situationen)
